          ...
          <>
            ...
            {state.restaurant && (
              <button
                ...
                className="flex items-center gap-3 p-3 sm:p-4 border-b hover:bg-muted/50 transition-colors w-full text-left min-h-[56px] touch-manipulation"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-base truncate" data-testid="text-cart-restaurant-name">{state.restaurant.name}</p>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-1">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-11 w-11 flex-shrink-0 -mr-1 touch-manipulation"
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="flex items-center gap-1 bg-muted rounded-full p-1">
                          ...
                          <span className="w-8 text-center text-base font-medium" data-testid={`text-item-quantity-${item.id}`}>
                            {item.quantity}
                          </span>
                          <Button
                            variant="ghost"
