...
export default function RestaurantSupportTicketDetail() {
  ...
  const replyMutation = useMutation({
    mutationFn: async () => {
      return apiRequest(`/api/admin/support/tickets/${ticketId}/messages`, {
        method: "POST",
        body: JSON.stringify({
  ...
  const statusMutation = useMutation({
    mutationFn: async () => {
      return apiRequest(`/api/admin/support/tickets/${ticketId}/status`, {
        method: "PATCH",
        body: JSON.stringify({
  ...
  const proposedResolutionMutation = useMutation({
    mutationFn: async () => {
      return apiRequest(`/api/admin/support/tickets/${ticketId}/proposed-resolution`, {
        method: "POST",
        body: JSON.stringify({
          proposedResolution,
