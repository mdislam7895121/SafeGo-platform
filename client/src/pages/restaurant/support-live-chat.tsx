...
export default function SupportLiveChat() {
  ...
  const { data: sessionData, isLoading: isLoadingSession } = useQuery<{ session: any }>({
    queryKey: ["/api/restaurant/support-center/live-chat", sessionId],
    enabled: !!sessionId,
  ...
  const startChatMutation = useMutation({
    mutationFn: async () => {
      return apiRequest("/api/restaurant/support-center/live-chat/start", {
        method: "POST",
      });
    },
    onSuccess: (data: any) => {
  ...
  const sendMessageMutation = useMutation({
    mutationFn: async (messageBody: string) => {
      return apiRequest(`/api/restaurant/support-center/live-chat/${sessionId}/messages`, {
        method: "POST",
  ...
  const endChatMutation = useMutation({
    mutationFn: async () => {
      return apiRequest(`/api/restaurant/support-center/live-chat/${sessionId}/end`, {
        method: "POST",
      });
    },
    onSuccess: () => {
