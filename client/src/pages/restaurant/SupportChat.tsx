...
export default function RestaurantSupportChat() {
  ...
  if (!selectedConversation) {
    return (
      <div className="p-6 space-y-4" data-testid="restaurant-support-chat">
        <h2 className="text-2xl font-bold">Support</h2>
        {conversations.length === 0 ? (
          <Button onClick={() => {}} data-testid="button-new-support-request">
            New Support Request
          </Button>
        ) : (
  ...
  return (
    <div className="p-6 space-y-4 h-full flex flex-col" data-testid="restaurant-support-chat-open">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold">Support Request</h2>
