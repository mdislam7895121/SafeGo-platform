    ...
    <div className="container mx-auto mt-6 py-6 px-4 md:px-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your restaurant staff and their permissions</p>
        </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Add your first staff member to start managing your restaurant team
            </p>
            <Button onClick={() => setShowAddDialog(true)} data-testid="button-add-first-staff">
              <UserPlus className="w-4 h-4 mr-2" />
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <CardTitle data-testid={`text-staff-name-${member.id}`}>{member.user.name}</CardTitle>
                      {member.staffActive ? (
      ...
      <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
        <DialogContent className="max-w-lg mx-auto px-4 md:px-6">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new staff account with a temporary password. The staff member will be prompted to change their
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid gap-3">
                <div className="flex items-center justify-between">
                  <Label htmlFor="canEditCategories" className="font-normal">
                    Edit Categories
                  </Label>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="canEditItems" className="font-normal">
                    Edit Menu Items
                  </Label>
                  <Switch
                    id="canEditItems"
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="canToggleAvailability" className="font-normal">
                    Toggle Availability
                  </Label>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="canUseBulkTools" className="font-normal">
                    Use Bulk Tools
                  </Label>
                  <Switch
                    id="canUseBulkTools"
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="canViewPayouts" className="font-normal">
                    View Payouts
                  </Label>
                  <Switch
                    id="canViewPayouts"
                ...
                <div className="flex items-center justify-between">
                  <Label htmlFor="canManageOrders" className="font-normal">
                    Manage Orders
                  </Label>
                  <Switch
                    id="canManageOrders"
