...
import { Store, ShoppingBag, Truck, Clock, MapPin } from "lucide-react";
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Discover and shop from thousands of local stores. Groceries, pharmacy, electronics, and more - all delivered to your doorstep.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Get your orders delivered quickly by our reliable delivery partners.
                </p>
              </div>
              ...
              <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Support local businesses in your neighborhood with every order.
                </p>
              </div>
              ...
              <div className="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Track your order from the store to your door in real-time.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              Shop Categories Coming Soon
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
              We're expanding our network of local shops. Sign up now to be the first to know when your favorite stores join SafeGo.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              {["Groceries", "Pharmacy", "Electronics", "Fashion", "Home & Garden", "Pet Supplies"].map((category) => (
                <span 
                  key={category}
