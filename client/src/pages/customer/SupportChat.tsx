...
export default function CustomerSupportChat() {
  ...
  if (!selectedConversation) {
    return (
      <div className="p-6 space-y-4" data-testid="customer-support-chat">
        <h2 className="text-2xl font-bold">Help & Support</h2>
        {conversations.length === 0 ? (
          <Button onClick={() => {}} data-testid="button-contact-support">
            Contact Support
          </Button>
        ) : (
  ...
  return (
    <div className="p-6 space-y-4 h-full flex flex-col" data-testid="customer-support-chat-open">
