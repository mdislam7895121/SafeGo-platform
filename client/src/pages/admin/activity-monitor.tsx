      ...
      <div className="bg-primary text-primary-foreground p-6 rounded-b-3xl shadow-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold">Admin Activity Monitor</h1>
            <p className="text-sm opacity-90">Real-time admin activity tracking with anomaly detection</p>
          </div>
          <div className="flex items-center gap-2">
            <Badge variant={autoRefresh ? "default" : "secondary"} className="cursor-pointer" onClick={() => setAutoRefresh(!autoRefresh)}>
              {autoRefresh ? "Live" : "Paused"}
            </Badge>
            <Button variant="ghost" size="icon" onClick={() => refetch()} className="text-primary-foreground hover:bg-primary-foreground/10" data-testid="button-refresh">
