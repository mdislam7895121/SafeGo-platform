...
import { Shield, Play, Pause, SkipBack, SkipForward, MapPin, Clock, AlertTriangle, User, Car, Phone, Video, Download } from "lucide-react";
...
export default function SafetyReplay() {
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      <PageHeader
        title="Safety Incident Replay"
        description="Review and analyze trip safety incidents"
        icon={Shield}
