...
import { DollarSign, RefreshCw, Search, Filter, AlertTriangle, CheckCircle, Clock, XCircle, MoreVertical, Download } from "lucide-react";
...
export default function RefundCenter() {
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      <PageHeader
        title="Refund & Adjustment Center"
        description="Process refunds, adjustments, and compensation claims"
        icon={DollarSign}
