        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Real-time monitoring of all services</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={autoRefresh ? "bg-green-600 hover:bg-green-700" : "bg-primary-foreground/10 border-primary-foreground/20 text-primary-foreground"}
