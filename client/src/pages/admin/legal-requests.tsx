...
import { Scale, FileText, Search, Filter, AlertTriangle, Clock, CheckCircle, XCircle, Eye, Download, Upload, Shield } from "lucide-react";
...
export default function LegalRequestsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      <PageHeader
        title="Legal Requests Dashboard"
        description="Manage law enforcement and legal compliance requests"
        icon={Scale}
