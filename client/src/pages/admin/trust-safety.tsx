...
import { Shield, AlertTriangle, FileText, Users, Clock, CheckCircle, XCircle, Scale, MessageSquare, Eye, FileWarning, Gavel, Flag, Ban, Award } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      <PageHeader
        ...
        description="Committee-based safety case review and decisions"
        icon={Scale}
