...
import { MessageSquare, Plus, Search, Edit, Trash2, Eye, Copy, Send, CheckCircle, Clock, Zap, Settings, Play, Pause } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      <PageHeader
        ...
        description="Create SMS templates and automated workflows"
        icon={MessageSquare}
