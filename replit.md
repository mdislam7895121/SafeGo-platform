...
*   **Unified Eats Experience**: Integrates a comprehensive DoorDash-style customer web experience at `/customer/eats` with demo content seeding, hero search, category browsing, featured carousels, restaurant detail pages with menu items, and a persistent cart drawer. Includes real-time menu stock sync and advanced promo code system.
