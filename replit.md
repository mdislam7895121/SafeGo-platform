...
-   **NYC TLC Congestion Pricing**: Implements $2.75 flat fee for trips with pickup OR dropoff in the Manhattan Congestion Zone (below 96th Street). Uses polygon-based geo-detection for precise zone boundary matching. Congestion fee is applied after TLC base fare calculation and before airport fees in the fare pipeline. Exposes congestionFee amount and congestionFeeApplied flag for transparent billing.
