...
export enum Permission {
  ...
  // Operations Console
  VIEW_OPERATIONS_CONSOLE = 'VIEW_OPERATIONS_CONSOLE',
  VIEW_SYSTEM_JOBS = 'VIEW_SYSTEM_JOBS',
  MANAGE_SYSTEM_JOBS = 'MANAGE_SYSTEM_JOBS',
  VIEW_HEALTH_CHECKS = 'VIEW_HEALTH_CHECKS',
