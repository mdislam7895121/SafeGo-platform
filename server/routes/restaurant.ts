...
const restaurantRegistrationSchema = z.object({
  restaurantInfo: z.object({
    ...
    state: z.string().optional(), // US only - 2-letter state code
    district: z.string().optional(), // BD only - district name
    zipCode: z.string().optional(), // US: ZIP code, BD: postal code
      ...
      if (restaurantProfile) {
        ...
        restaurantProfile = await tx.restaurantProfile.update({
          ...
          data: {
            ...
            state: restaurantInfo.state || null,
            district: restaurantInfo.district || null,
            zipCode: restaurantInfo.zipCode || null,
